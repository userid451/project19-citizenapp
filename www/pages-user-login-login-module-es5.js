...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-user-login-login-module"], {
  ...
  function srcAppPagesUserLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginPage = /*#__PURE__*/function () {
      ...
      _createClass(LoginPage, [{
        ...
        value: function ngOnInit() {
          this.userService.getAuthenticatedUser().then(function (data) {// if (data) {
        ...
        value: function onSignIn() {
          ...
          this.userService.authenticate(this.loginForm.controls['email'].value, this.loginForm.controls['password'].value).then(function (user) {
            if (!user) {
              _this.loginForm.controls['login'].setErrors({
                'incorrect': true
              });
            } else {
        ...
        value: function onForgotPassword() {//Todo
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _api_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], LoginPage);
    /***/
  }
}]);
